...
class RocketSensorData:
    ...
    def _start_continuous_sensor_data_update(self, update_interval: float):
        """
    ...
    def start_updating(self):
        ...
        """
        update_thread = threading.Thread(target=self._start_continuous_sensor_data_update, args=(1.0,))
